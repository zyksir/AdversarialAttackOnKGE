...
class BaseTrainer(object):
    ...
    def get_trainer(input_data, args):
        ...
        config = yaml.load(open('/content/drive/MyDrive/AdversarialAttackOnKGE/codes/noise_generator/configs/rgcn/lp-FB-toy.yaml', "r"))
        print(config)
        
        kge_model = LinkPredictor(
        nnodes=args.nentity,
        nrel=args.nrelation,
        ...
        print(args.nentity, args.nrelation, args.hidden_dim, args.double_entity_embedding, args.double_relation_embedding)
    ...
    def load_model(self):
        ...
        for i in checkpoint:
          print(checkpoint[i].shape)
        self.kge_model.load_state_dict(checkpoint)
