...
class LinkPredictor(nn.Module):
    ...
    def forward(self, graph, triples, x, perturb_r=False, pertubation=None):
        ...
        if (perturb_r == False):
          scores, r_gradient = self.scoring_function(triples, x)
        else:
          scores, r_gradient = self.scoring_function(triples, x, perturb_r=True, pertubation=pertubation)
        # Checkpoint 7
        ...
        return scores, penalty, r_gradient
